...
You can download the latest build of Tuinity by going [here](https://github.com/Spottedleaf/Tuinity/actions?query=workflow%3A%22Java+CI%22+branch%3Amaster+event%3Apush), 
